...
<div class="header">
  ...
  <div class="main">
     <div class="grid2">
    <div class="textbox">
      <h1> O quanto você sabe sobre Steven universo? Descrubra com o nosso quiz! </h1>
    </div>
    </div>
  </div>
  ...
  <button class="sparkle-button">
    ...
    <span class="text, buttoncontent"><img src="https://see.fontimg.com/api/renderfont4/KYqZ/eyJyIjoiZnMiLCJoIjo0OSwidyI6MTAwMCwiZnMiOjQ5LCJmZ2MiOiIjRjkzRTY4IiwiYmdjIjoiI0ZGRkZGRiIsInQiOjF9/SW5pY2lhciE/crewniverse.png" alt="Steven Universe fonts" weight="50px" height="50px"></span>
  </button>
 ...
 <form class="colorful-form" action="home.php" method="post">
  ...
  <button class="form-button" type="submit"><a href="unipag.php">começar</button>
</form>
